...
// Esqueleto de la app del conductor: header oscuro + tarjetas de entrega.
// Se reutiliza en app/driver/loading.tsx (navegación) y dentro de DriverApp
// mientras se resuelve el fetch de datos en cliente.
