...
| 3 | `LANDING-handoff.md` | La **landing page** de marketing: hero oscuro con mapa "EN VIVO" + **secciones intercaladas claro/oscuro** (Producto blanco, demo claro, Precios oscuro), planes de precios y CTA. | `Despachr Landing.dc.html` |
| 3b | `LANDING-mapa-en-vivo.md` | **Guía técnica del mapa "EN VIVO"** — capas, animaciones y **migración a Mapbox** (mapa oscuro con marco/halo para contraste). | `screenshots/landing-01-hero.png` |
...
- `Despachr Landing.dc.html` — prototipo de la landing page: hero oscuro con mapa "EN VIVO" animado + secciones intercaladas claro/oscuro (Producto, Cómo funciona, Plataforma/demo, Precios) + CTA.
